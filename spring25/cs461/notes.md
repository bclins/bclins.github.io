...
1. Draw a parse tree for the S-expression `(* (+ 5 6) (- 4 2))`.
...
4. If $L_1$ and $L_2$ are both context-free languages, explain why the union $L_1 \cup L_2$ is context free. 

5. If $L_1$ and $L_2$ are both context-free languages, explain why the concatenation $L_1 \circ L_2$ is context free.
