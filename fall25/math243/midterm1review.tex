...
\part Show that $y(3) = (1+3i) e^{(-1 + 2i)t} + (1-3i) e^{(-1 - 2i)t}$ is a solution that satisfies the initial conditions $y(0) = 2$ and $y'(0) = 10$. 
\vfill

\part Show that $y(t) = 2e^{-t} \cos (2t) + 6 e^{-t} \sin(2t)$ is also a solution that satisfies the initial conditions $y(0) = 2$ and $y'(0) = 10$. 
\vfill
