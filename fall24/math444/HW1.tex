...
\item $\im \left(\dfrac{12}{5 - i}\right)$ % 6/13
\item $(3-2i)(4+i)$ % 14 - 5i
\item $\dfrac{1-i}{1+i}$ % -i
\setcounter{enumCount}{\theenumi}
\end{enumerate}
\end{multicols}
\vfill
...
\begin{enumerate}
\setcounter{enumi}{\theenumCount}
\item $ \left|\dfrac{1}{5 + 12i}\right|$ % 1/13
\item $\overline{(3+4i)(1-i)}$ % 7 - i
\item $\overline{e^{i\frac{\pi}{3}}}$ % e^{-\pi i/ 3}
\setcounter{enumCount}{\theenumi}
\end{enumerate}
\end{multicols}
\vfill
...
\begin{enumerate}
\setcounter{enumi}{\theenumCount}
\item $\tfrac{1}{2} + \tfrac{\sqrt{3}}{2}i$ % e^{\pi i /3}
\item $i-1$ % \sqrt{2} e^{3 \pi i/4}
\item $\dfrac{i}{1+i}$ % 1/\sqrt{2} e^{\pi i/4}
\setcounter{enumCount}{\theenumi}
\end{enumerate}
\end{multicols}
\vfill
...
\begin{enumerate}
\setcounter{enumi}{\theenumCount}
\item $e^{5\pi i/3}$ % \tfrac{1}{2} - \tfrac{\sqrt{3}}{2} i
\item $e^{-\pi i /4}$ % \tfrac{\sqrt{2}}{2} - \tfrac{\sqrt{2}}{2} i 
\item $(\sqrt{3}\, e^{7\pi i /12}) (\sqrt{12}\, e^{29 \pi i/ 12})$ % -6
\setcounter{enumCount}{\theenumi}
\end{enumerate}
\end{multicols}
\vfill
