...
dim(df)
# Averages
apply(df, MARGIN = 2, FUN = mean) # Applies the function mean() to the columns. MARGIN = 1 would apply the function to the rows instead.
# Standard deviations
...
That's might be an issue since the sample size is small ($n = 16$). 
