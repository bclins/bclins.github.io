...
$$\mathbf{v}_2 = \mathbf{x}_2 - \frac{\inner{\mathbf{v_1}, \mathbf{x}_2}}{\inner{\mathbf{v}_1, \mathbf{v}_1}} \mathbf{v}_1 = \begin{bmatrix} 3 \\ -1 \\ 1 \end{bmatrix} - \frac{2}{2} \begin{bmatrix} 1 \\ 1 \\ 0 \end{bmatrix} = \begin{bmatrix} 2 \\ -2 \\ 0 \end{bmatrix}$$
$$\mathbf{v}_3 = \mathbf{x}_3 - \frac{\inner{\mathbf{v_1}, \mathbf{x}_3}}{\inner{\mathbf{v}_1, \mathbf{v}_1}} \mathbf{v}_1 -  \frac{\inner{\mathbf{v_2}, \mathbf{x}_3}}{\inner{\mathbf{v}_2, \mathbf{v}_2}} \mathbf{v}_2 = \begin{bmatrix} 0 \\ 2 \\ -5 \end{bmatrix} - \frac{2}{2} \begin{bmatrix} 1 \\ 1 \\ 0 \end{bmatrix} \mathbf{v}_1 - \frac{-4}{8} \begin{bmatrix} 2 \\ -2 \\ 0 \end{bmatrix} \mathbf{v}_2 = \begin{bmatrix} 0 \\ 0 \\ -5 \end{bmatrix}$$
\end{solution}
\vfill
\vfill
