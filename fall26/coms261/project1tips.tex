...
\begin{enumerate}
\item How many spaces do you need to print in each row before the first character of the diamond? You need to figure out the pattern of spaces and symbols to print in order to make the diamond.  
...
\item A string can be all blank spaces like this: \verb|" "| or this: \verb|"     "|.
...
%\item You can print blank spaces with the command 
%\begin{center}
%\verb|print(" ", end = "")|
%\end{center}
%and you can create $n$ blank spaces for any integer $n$ with a command like:
%\begin{center}
%\verb|print(" " * n, end = "")|
%\end{center}
