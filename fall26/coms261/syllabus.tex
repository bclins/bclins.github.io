...
Artificial intelligence can easily solve all of the programming exercises you will encounter in this course. Using AI to solve programming problems is a great way to avoid learning.  For that reason, AI use is strictly prohibited on projects and tests in this class.  
