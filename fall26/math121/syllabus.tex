...
Course Meeting Times & MWF 11:30am - 12:20pm (Section 02) \& MWF 1:30pm - 2:20pm (Section 04)\\ \hline
Course Meeting Location & Pauley 100 (Section 02) \& Pauley 105 (Section 04) \\ \hline
Office Hours & MW 2:30 - 4:00pm \& R 12:30 - 2:00pm \\ 
...
\begin{enumerate}
\item \textbf{Grade: A.} Every part of the assignment is complete and your work is clear and correct.  
...
\item \textbf{Grade: D.} You turn in something, but it has major errors or omissions.  
\end{enumerate}
 
The dates listed for the projects on the schedule below are when the projects \emph{will be assigned}, not when they are due.  You will have at least 3 days from when a project is assigned until it will be due.  
...
12  & Inference about means  & Project 2 \\
13  & Two sample t-methods, Midterm 3  & \\
14  & Statistical power  & Project 3  \\ 
15  & Chi-squared test for association  &  \\ \hline
\end{tabular}
\end{center}

\subsubsection*{Late Work and Make-Up Assignment Policy}

Please let me know at least one day in advance if you will be missing class on a quiz day. If you let me know ahead of time that you will be missing a quiz for a religious holiday or school sponsored event, then we can plan an alternative assignment or waive the quiz from your average. If you don't let me know until after the fact, then it will be too late.  There are no make-up quizzes.  That's why I drop your lowest quiz grade. 
...
You are welcome and even encouraged to use artificial intelligence to help study before quizzes and tests.   But all outside resources (including AI) are prohibited during quizzes and tests.  You should not use AI to help with any part of the homework projects. Including AI generated text or results in your projects is plagiarism.  
